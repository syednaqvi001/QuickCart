-- ============================================
-- QuickCart Database Initialization Script
-- ============================================
-- This script creates all tables for QuickCart
-- including users, products, orders, and more
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'DeliveryStatus') THEN
        CREATE TYPE "DeliveryStatus" AS ENUM ('PENDING', 'ASSIGNED', 'EN_ROUTE', 'ARRIVED', 'COMPLETED', 'FAILED');
    END IF;
END $$;
